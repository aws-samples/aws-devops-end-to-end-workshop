...
export class LoadPages extends Component<AppProps, AppState> {
        ...
        {!this.state.isAuthenticating &&
          <div className="App container">
            <Navbar fluid collapseOnSelect>
              ...
              <Navbar.Collapse>
                <Nav pullRight>
                  {this.context.isAuthenticated ? this.showLoggedInBar() : this.showLoggedOutBar()}
                </Nav>
              </Navbar.Collapse>
            </Navbar>
            <AppRoutes/>
